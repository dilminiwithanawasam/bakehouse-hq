...
export const MOCK_USERS: User[] = [
  { id: "u1", name: "Rajith Perera",   email: "admin@bakery.com",       role: "admin",       status: "active", lastLogin: "2026-05-26 08:12" },
  { id: "u2", name: "Lakshmi de Silva", email: "manager@bakery.com",     role: "manager",     status: "active", lastLogin: "2026-05-26 07:48" },
  { id: "u3", name: "Arjun Kumar",     email: "sales@bakery.com",       role: "salesperson", status: "active", lastLogin: "2026-05-26 06:15" },
  { id: "u4", name: "Amisha Fernando", email: "sales2@bakery.com",      role: "salesperson", status: "active", lastLogin: "2026-05-25 19:02" },
  { id: "u5", name: "Sanjay Mendis",   email: "manager2@bakery.com",    role: "manager",     status: "disabled", lastLogin: "2026-05-20 09:33" },
];
...
export const WASTAGES: Wastage[] = [
  { id: "w1", date: daysAgo(0), productId: "p3",  qty: 4, reason: "Expired",        loss: 220, recordedBy: "Arjun Kumar" },
  { id: "w2", date: daysAgo(0), productId: "p4",  qty: 1, reason: "Damaged",        loss: 75, recordedBy: "Amisha Fernando" },
  { id: "w3", date: daysAgo(1), productId: "p10", qty: 3, reason: "Overproduction", loss: 360, recordedBy: "Arjun Kumar" },
  { id: "w4", date: daysAgo(2), productId: "p2",  qty: 5, reason: "Expired",        loss: 250, recordedBy: "Amisha Fernando" },
  { id: "w5", date: daysAgo(3), productId: "p9",  qty: 2, reason: "Returned",       loss: 120, recordedBy: "Arjun Kumar" },
  { id: "w6", date: daysAgo(4), productId: "p6",  qty: 3, reason: "Damaged",        loss: 105, recordedBy: "Amisha Fernando" },
  { id: "w7", date: daysAgo(5), productId: "p3",  qty: 6, reason: "Expired",        loss: 330, recordedBy: "Arjun Kumar" },
];
...
export const currency = (n: number, code?: string) => {
  ...
  const cfg = CURRENCY_MAP[cur] || CURRENCY_MAP.INR;
  try {
