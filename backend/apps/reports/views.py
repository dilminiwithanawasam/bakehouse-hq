...
def dashboard_view(request):
    ...
    try:
        ...
        data = {
            'today_stats': analytics.get_today_stats(start_date=start_date, end_date=end_date, product_id=product_id, category_id=category_id),
            'period_comparison': analytics.get_period_comparison(days=1, start_date=start_date, end_date=end_date, product_id=product_id, category_id=category_id),
            'top_products': analytics.get_top_products(limit=5, start_date=start_date, end_date=end_date, product_id=product_id, category_id=category_id),
            'low_stock_alerts': analytics.get_low_stock_alert(),
            'wastage_breakdown': analytics.get_wastage_breakdown(start_date=start_date, end_date=end_date, product_id=product_id, category_id=category_id),
        }
...
def sales_report_view(request):
    ...
    try:
        ...
        data = {
            ...
            'by_date': analytics.get_sales_by_date(start, end, product_id=product_id, category_id=category_id),
            'by_payment': analytics.get_sales_by_payment_method(start, end, product_id=product_id, category_id=category_id),
            'by_category': analytics.get_sales_by_category(start, end, product_id=product_id, category_id=category_id),
        }
...
def sales_report_pdf_view(request):
    ...
    try:
        ...
        analytics = SalesAnalytics()
        rows = analytics.get_sales_by_date(start, end, product_id=product_id, category_id=category_id)
        payments = analytics.get_sales_by_payment_method(start, end, product_id=product_id, category_id=category_id)
...
def wastage_report_view(request):
    ...
    try:
        ...
        data = {
            ...
            'trend': analytics.get_wastage_trend(start, end, product_id=product_id, category_id=category_id),
            'by_product': analytics.get_wastage_by_product(start, end, limit=10, product_id=product_id, category_id=category_id),
            'by_reason': analytics.get_wastage_breakdown(start, end, product_id=product_id, category_id=category_id),
        }
